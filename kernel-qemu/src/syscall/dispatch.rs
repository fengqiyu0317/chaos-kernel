...
impl Kernel {
    ...
    fn dispatch_syscall_raw(
        ...
        match nr {
            ...
            SYS_MKDIRAT => returning(sys_mkdirat(self, a0, a1, a2)),
            ...
            SYS_FSTAT => returning(sys_fstat(self, a0, a1)),
            SYS_NEWFSTATAT => returning(sys_newfstatat(self, a0, a1, a2, a3)),
            ...
            SYS_CLONE => returning(sys_clone(self, a0, a1, a2, a3, a4, caller_frame)),
            ...
            SYS_GETTID => returning(sys_gettid(self)),
            ...
            SYS_GETSID => returning(sys_getsid(self, a0)),
